...
class SudokuRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sudoku.SudokuRequest) */ {
 public:
  ...
  inline SudokuRequest* New() const PROTOBUF_FINAL { return New(NULL); }

  SudokuRequest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class SudokuResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sudoku.SudokuResponse) */ {
 public:
  ...
  inline SudokuResponse* New() const PROTOBUF_FINAL { return New(NULL); }

  SudokuResponse* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
