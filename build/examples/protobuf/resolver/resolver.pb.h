...
class ResolveRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:resolver.ResolveRequest) */ {
 public:
  ...
  inline ResolveRequest* New() const PROTOBUF_FINAL { return New(NULL); }

  ResolveRequest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class ResolveResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:resolver.ResolveResponse) */ {
 public:
  ...
  inline ResolveResponse* New() const PROTOBUF_FINAL { return New(NULL); }

  ResolveResponse* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
